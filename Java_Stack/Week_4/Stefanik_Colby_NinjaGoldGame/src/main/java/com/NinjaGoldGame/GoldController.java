...
public class GoldController {
	...
	public String index(
		...
		if(farm != null) {
			...
			actions.add(0, "You worked on a farm and earned " + amount + " gold. (" + format.format(new Date()) + ")");
		...
		if(cave != null) {
			...
			session.setAttribute("gold", gold);
			actions.add(0, "You explored a cave and earned " + amount + " gold. (" + format.format(new Date()) + ")");
		...
		if(house != null) {
			...
			session.setAttribute("gold", gold);
			actions.add(0, "You burgled a house and earned " + amount + " gold. (" + format.format(new Date()) + ")"); //Kinda sus there
