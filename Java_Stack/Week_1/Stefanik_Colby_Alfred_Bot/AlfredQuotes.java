...
public class AlfredQuotes {
    ...
    public String guestGreeting(String name) {
        return String.format("Good day. Lovely to see you, " + name);
    }

    public String guestGreeting(String name, boolean batman) {
        return String.format("Good day. Lovely to see you, Master " + name);
    }
